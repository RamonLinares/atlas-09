...
report=[]
for library,names in [(1,['Walk_Loop','Jog_Fwd_Loop','Sprint_Loop','Punch_Jab','Punch_Cross','Death01','Hit_Chest','Hit_Head','Roll']),(2,['Melee_Hook','Melee_Hook_Rec','Hit_Knockback','Sword_Regular_Combo','Sword_Block','Sword_Regular_B','Sword_Regular_B_Rec'])]:
