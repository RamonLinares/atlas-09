...
ROOT=Path(__file__).resolve().parents[1];OUT=ROOT/'output/scorpio-05/rig-inspection';OUT.mkdir(parents=True,exist_ok=True)
...
bpy.ops.object.camera_add(location=(0,-45,8.5));c=bpy.context.object;c.data.type='ORTHO';c.data.ortho_scale=22;aim(c)
...
for name,pos in [('front',(0,-45,8.5)),('side',(45,0,8.5)),('back',(0,45,8.5))]:
