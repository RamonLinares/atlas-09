...
The repair follows the visible tail joints, places the knees and ankles at their actual hinges, binds the complete knee shields to the thighs, and separates the front head from the torso. Attack poses use continuous curves with matching endpoints. StingerStrike cocks the tail rearward, whips it forward and down in 0.24 seconds, then recovers. The torso coils backward and leans into the stinger hit. ClawSlash delivers sequential right and left pincer strikes with alternating torso twists, distinct pullbacks and 0.24-second forward hits. The arms follow the torso frame while the feet remain planted. Validation requires each attack to extend at least 2 m beyond its resting forward reach. Claws carry forward without inheriting leftover wrist rotations. Kneeling seats the armor and re-solves the front boot; recoil rotates the attached stinger and fires along its barrel. All six clips are regenerated locally; no new generation credits were used.
